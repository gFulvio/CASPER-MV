...
namespace Assembly_CSharp
{
    ...
    {
        /// <summary>
        /// model input class for MovementClassifier.
        /// </summary>
        ...
        /// <summary>
        /// model output class for MovementClassifier.
        /// </summary>
        #region model output class
        public class ModelOutput
        {
            [ColumnName(@"QDC")]
            public float[] QDC { get; set; }

            [ColumnName(@"QTC")]
            public float[] QTC { get; set; }
        ...
        private static string MLNetModelPath = Path.GetFullPath("Assets/Scripts/MLNETScripts/MovementClassifier.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("MOVEMENT");
            if (labelColumn == null)
            {
                throw new Exception("MOVEMENT column not found. Make sure the name searched for matches the name in the schema.");
            }
